...
import { IActivity, IGetActivityPayload, IPaginationResponse } from "../../interfaces/activity.interface";
...
function AdminActivityLogs() {
    ...
    const { value: getAuthResponse } = useLocalStorage<IApiResponse | null>("auth_response", null);
    ...
    const getActivities = async (page: number = 1) => {
        ...
        const activitiesResponse = await HttpClient
    ...
    return (
        <>
            ...
            <Modal
                ...
                onOk={handleOk}>
                <p>Authentication session has expired. Kindly proceed to log in again for continued access.</p>
            </Modal>
        </>
    );
}
