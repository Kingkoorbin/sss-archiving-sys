...
function AdminDashboard() {
    ...
    const handleGetDailyResults = async () => {
        ...
        const mappedData = getDailyResultsResp.data.map(
            (result: IDailyResult) => ({
                        ...
                        >
                            ...
                            >
                                ...
                                <Text style={{ fontSize: "22px" }}>
                                    {dayjs(
                                        state.subscriptionExpiryInDate,
                                    ).format("MMMM DD, YYYY")}
                                </Text>
                            </div>
                            <Countdown
                                ...
                                onFinish={onSubscriptionFinished}
                            />
                            <Divider />
                            <div
                                style={{
