...
function Register() {
  ...
  const onProceed = async (data: IInputs) => {
    ...
    navigate(
      `/register/${data.email.substring(0, data.email.indexOf('@'))}/role`
    );
  };
        ...
        <form onSubmit={handleSubmit(onProceed)}>
          ...
          <VStack gap={'1'} align={'start'} mt={'10'}>
            <Input
              ...
              focusBorderColor={
                errors.email || state.loginErrorMessage
                  ? 'red.300'
                  : 'blackAlpha.100'
              }
              borderColor={
            ...
            <InputGroup>
              ...
              <Input
                ...
                placeholder="+639******123"
                focusBorderColor={
                  errors.mobileNumber || state.loginErrorMessage
                    ? 'red.300'
                    : 'blackAlpha.100'
                }
                borderColor={
                ...
                {...register('mobileNumber', {
                  ...
                  pattern: {
                    value: /^\+639\d{9}$/i,
                    message:
                      'Mobile No. should be in this format: +639123456789',
                  },
                })}
              />
            </InputGroup>
            ...
            <InputGroup size="md">
              <Input
                ...
                focusBorderColor={
                  errors.password || state.loginErrorMessage
                    ? 'red.300'
                    : 'blackAlpha.100'
                }
                borderColor={
                ...
                {...register('password', {
                  ...
                  pattern: {
                    ...
                    message:
                      'Password should have 1 uppercase letter, 1 lowercase letter and 1 number and 1 special character',
                  },
                })}
              />
            ...
            <Input
              ...
              focusBorderColor={
                errors.passwordConfirm || state.loginErrorMessage
                  ? 'red.300'
                  : 'blackAlpha.100'
              }
              borderColor={
